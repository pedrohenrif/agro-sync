...
import { ListChecks, Calendar, ClipboardCheck } from "lucide-react";
import {
  LayoutDashboard,
  PlusSquare,
  List,
    ...
    <div className={`layout-container ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/gardens" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"}> <List size={18} /> <span>Meus Canteiros</span> </NavLink>
          <NavLink to="/supply-stock" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"}> <Archive size={18} /> <span>Estoque</span> </NavLink>
          <NavLink to="/crop-plans" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"}><ClipboardCheck size={18} /><span>Planos de Cultivo</span></NavLink>
